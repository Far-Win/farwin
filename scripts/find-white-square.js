...
async function main() {
  const CURVE_ADDRESS = "0xb6346cdB3225C5e9EA799461c216c50c26f70d63";
  const NFT_ADDRESS = "0x26e8f6f90341bB558630602F69102e4bF853e5B4";
  ...
  try {
    ...
    while (!foundRareNFT) {
      ...
      await new Promise((resolve) => setTimeout(resolve, 4000)); // Wait 1.5 seconds
